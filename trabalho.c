...
#define N_TORRE 1 //1
#define TEMPO_SIMULACAO 180
#define TEMPO_ALERTA 60
#define TEMPO_CRITICO 90
#define FREQUENCIA_DE_AVIAO 50 // nao pode ser 0
...
typedef struct node_log {
    ...
    int id;
    int tempo_operacao; // Novo campo para tempo de operação
...
typedef struct t_node_aviao {
    ...
    time_t tempo_inicio_operacao; // Novo campo para cronometrar operações
